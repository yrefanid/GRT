...
goal([at(p15,c4_2),at(p14,c4_2),at(p13,c4_3),at(p12,c2_2),at(p11,c2_1),at(p10,c4_2),at(p9,c4_2),at(p8,c4_2), 
out(p15),out(p14),out(p13),out(p12),out(p11),out(p10),out(p9),out(p8)])-!.
