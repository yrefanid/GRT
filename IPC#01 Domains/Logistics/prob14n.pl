...
goal([at(p29,c5_2),at(p28,c11_2),at(p27,c10_1),at(p26,c9_1),at(p25,c4_1),at(p24,c8_2),at(p23,c10_2),at(p22,c1_2),at(p21,c1_1),at(p20,c4_1),at(p19,c6_1),at(p18,c9_1),at(p17,c4_1),at(p16,c11_1),at(p15,c2_2),at(p14,c8_2),at(p13,c10_2),
at(p12,c11_2),at(p11,c2_2), 
out(p11), out(p12), out(p13), out(p14), out(p15), out(p16), out(p17), out(p18), out(p19), out(p20),out(p21), out(p22), out(p23), out(p24), out(p25), out(p26), out(p27), out(p28), out(p29)]):-!.
