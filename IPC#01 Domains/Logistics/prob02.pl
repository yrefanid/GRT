...
airports( [ c1_2, c2_2, c3_2, c4_2, c5_2, c6_2, c7_2, c8_2, c9_2, c10_2] ) .
locations( [ c1_1, c1_2, c2_1, c2_2, c3_1, c3_2, c4_1, c4_2, c5_1, c5_2, c6_1, c6_2 ,c7_1, c7_2, 
	c8_1, c8_2, c9_1, c9_2, c10_1, c10_2 ] ) .
trucks( [ tr1 , tr2 , tr3, tr4, tr5, tr6, tr7, tr8, tr9, tr10] ) .
...
initial([at(pl4, c3_2),at(pl3, c7_2), at(pl2,c3_2), at(pl1,c6_2),
	at(tr10,c10_1), at(tr9,c9_1), at(tr8,c8_1), at(tr7,c7_1),at(tr6,c6_1),
	at(tr5,c5_1),at(tr4,c4_1), at(tr3,c3_1), at(tr2,c2_1),at(tr1,c1_1),
	at(p5,c1_2),at(p4,c7_2),at(p3,c3_2), at(p2,c10_1),at(p1,c2_2),
	out(p5), out(p4), out(p3), out(p2), out(p1)]):-!.

goal([at(p5,c4_2), at(p4,c6_1), at(p3,c1_1), at(p2,c9_2),at(p1,c3_1),
	out(p5), out(p4), out(p3), out(p2), out(p1)]):-!.
