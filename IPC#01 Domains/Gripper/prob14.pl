problem_name('gripper14.txt').

rooms([rooma,roomb]).
balls([ball30,ball29,ball28,ball27,ball26,ball25,
...
ball6,ball5,ball4,ball3,ball2,ball1]).
grippers([left,right]).
