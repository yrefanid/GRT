problem_name('gripper08.txt').

rooms([rooma,roomb]).
balls([ball18,ball17,ball16,ball15,ball14,ball13,
...
initial([at_robby(rooma),free(left),free(right),at(ball18,rooma),at(ball17,rooma),at(ball16,rooma),at(ball15,rooma),at(ball14,rooma),at(ball13,rooma),at(ball12,rooma),at(ball11,rooma),at(ball10,rooma),at(ball9,rooma),at(ball8,rooma),at(ball7,rooma),at(ball6,rooma),at(ball5,rooma),at(ball4,rooma),at(ball3,rooma),at(ball2,rooma),at(ball1,rooma)]):-!.
goal([at(ball18,roomb),at(ball17,roomb),at(ball16,roomb),at(ball15,roomb),at(ball14,roomb),at(ball13,roomb),at(ball12,roomb),at(ball11,roomb),at(ball10,roomb),at(ball9,roomb),at(ball8,roomb),at(ball7,roomb),at(ball6,roomb),at(ball5,roomb),at(ball4,roomb),at(ball3,roomb),at(ball2,roomb),at(ball1,roomb)]):-!.
