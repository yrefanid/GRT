problem_name('gripper02.txt').

rooms([rooma,roomb]).
balls([ball6,ball5,ball4,ball3,ball2,ball1]).
grippers([left,right]).
...
initial([at_robby(rooma),free(left),free(right),at(ball6,rooma),at(ball5,rooma),at(ball4,rooma),at(ball3,rooma),at(ball2,rooma),at(ball1,rooma)]):-!.

goal([at(ball6,roomb),at(ball5,roomb),at(ball4,roomb),at(ball3,roomb),at(ball2,roomb),at(ball1,roomb)]):-!.
