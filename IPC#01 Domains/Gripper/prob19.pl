problem_name('gripper19.txt').

rooms([rooma,roomb]).
balls([ball40,ball39,ball38,ball37,ball36,ball35,
...
ball7,ball6,ball5,ball4,ball3,ball2,ball1]).
grippers([left,right]).
