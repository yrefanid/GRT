problem_name('gripper01.txt').

rooms([rooma,roomb]).
balls([ball4,ball3,ball2,ball1]).
grippers([left,right]).
...
initial([at_robby(rooma),free(left),free(right),at(ball4,rooma),at(ball3,rooma),at(ball2,rooma),at(ball1,rooma)]):-!.
goal([at(ball4,roomb),at(ball3,roomb),at(ball2,roomb),at(ball1,roomb)]):-!.
