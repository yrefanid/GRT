problem_name('gripper20.txt').

rooms([rooma,roomb]).
balls([ball42,ball41,ball40,ball39,ball38,ball37,
...
ball9,ball8,ball7,ball6,ball5,ball4,ball3,ball2,ball1]).
grippers([left,right]).
