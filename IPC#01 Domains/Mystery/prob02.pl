...
not_determined(craves(satiety,beef)).
not_determined(craves(stimulation,flounder)).
not_determined(craves(curiosity,cherry)).
not_determined(craves(entertainment,ham)).
