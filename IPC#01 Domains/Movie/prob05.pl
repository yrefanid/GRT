problem_name('movie05.txt').

chips([c1,c2,c3,c4,c5,c6,c8,c9]).
dip([d1,d2,d3,d4,d5,d6,d8,d9]).
pop([p1,p2,p3,p4,p5,p6,p8,p9]).
cheese([z1,z2,z3,z4,z5,z6,z8,z9]).
crackers([k1,k2,k3,k4,k5,k6,k8,k9]).
